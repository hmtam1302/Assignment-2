            ...
            <div class="form-container sign-up-container">
                <form action="#">
                    ...
                    <div class="form-group">
                        <input type="text" name="username" class="form-control animate__animated" id="username" placeholder="Username" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required>

                    </div>
                    <div class="form-group">
                        <input type="email" class="form-control animate__animated" name="email" id="email" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email" required>

                    </div>
                    <div class="form-group">
                        <input type="password" name="password" class="form-control animate__animated" id="password" placeholder="Password" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required>
            ...
            <div class="form-container sign-in-container">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                        <!-- fix -->
                        <input type="text" name="username" class="form-control animate__animated" id="username-signin" placeholder="Username" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required value="<?php echo $username; ?>"> <!-- fix -->
                        <span class="text-danger"><?php echo $username_err; ?></span> <!-- fix -->

                    </div>
                    <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                        <!-- fix -->
                        <input type="password" name="password" class="form-control animate__animated" id="password-signin" required placeholder="Password" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
                        <span class="text-danger"><?php echo $password_err; ?></span> <!-- fix -->

                    </div>
                    <a href="#" class="my-2">Forgot your password?</a>
                    <button class="btn btn-outline-primary btn-rounded px-5" onclick="signin()">Sign In</button>
                </form>
            </div>
